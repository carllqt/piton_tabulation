        ...
        <DropdownMenu>
          ...
          <SidebarMenuButton
            ...
            className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground 
                      ...
                      text-white hover:from-blue-600 hover:text-white hover:via-blue-700 hover:to-blue-800 
                      gap-3 h-24 px-4">
            <div
              className="flex aspect-square size-12 items-center justify-center rounded-lg">
              <img src="/PITON LOGO.png" alt="Team Logo" className="size-12 object-contain" />
            </div>
