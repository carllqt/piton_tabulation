...
const Sports = ({ auth, contestants, existingScores }) => {
    const user = auth?.user
    const breadcrumbs = [{ label: "Sports", href: "#" }]
    const maxScore = 10
    const endpoint = "/sports_scores"
    ...
    return (
        ...
        <div className="flex justify-center items-start">
            <div className="w-1/2">
            <div className="mb-4">
                <h2 className="text-2xl font-bold text-center">Sports 10%</h2>
            </div>
